...
const signupSchema = Joi.object({
    ...
    confirm_password: Joi.string().required().valid(Joi.ref('password')),// เทียบค่าว่า มีค่าเท่ากับ password
...
router.post("/user/signup", async (req, res, next) => {
    ...
    const password = await bcrypt.hash(req.body.password, 5) //ทำให้อ่านค่า password ไม่ได้
